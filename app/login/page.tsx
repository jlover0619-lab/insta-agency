    ...
    <div className="h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">MY PLAN</h1>
          <p className="text-sm text-gray-400 mt-1">목표 · 습관 · 일정을 한 곳에</p>
        </div>
        ...
        <p className="text-xs text-gray-400 text-center">
          로그인하면 모든 기기에서<br />데이터가 자동으로 동기화돼요
        </p>
      </div>
    </div>
  )
